...
<div class="brand-view">
    ...
    <div class="jumbotron " >
	  ...
	  <p class='text-left'><a class="btn btn-primary btn-lg" href="<?= Html::encode($model->baidubaike) ?>" role="button">Learn more</a></p>
	</div>
	<?php Pjax::begin();?>
    <p class='text-center'>
    	<a data-pjax="0" href="<?= Url::to(['thumbsup','id' => $model->id])?>">  
		  ...
		  <span class="badge" aria-hidden="true"><?= Html::encode($model->thumbsup) ?></span>
		  &nbsp;|
		 <a data-pjax="true" href="<?= Url::to(['thumbsdown','id' => $model->id])?>">  
		  <span class="glyphicon glyphicon-thumbs-down" aria-hidden="true"></span>
		 </a>
		  <span class="badge" aria-hidden="true"><?= Html::encode($model->thumbsdown) ?></span>
		  &nbsp;|
		  <span class="glyphicon glyphicon-comment" aria-hidden="true"></span>
		  <span class="badge" aria-hidden="true"><?= Html::encode($model->comment_count) ?></span>
		  &nbsp;|
		  <span class="glyphicon glyphicon-eye-open"></span>
		  <span class="badge"><?= Html::encode($model->view_count) ?></span>		  
	</p>
	<?php Pjax::end();?>
	<p class='text-center'>
