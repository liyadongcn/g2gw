    	...
    	return [
    			...
    			'image-upload' => [
    			 'class' => 'vova07\imperavi\actions\UploadAction',
    					'url' =>  Yii::$app->request->hostInfo.'/uploads/posts/', // Directory URL address, where files are stored.
    					'path' => '@frontend/web/uploads/posts' // Or absolute path to directory where files are stored.
    			],   
    	];
    }
